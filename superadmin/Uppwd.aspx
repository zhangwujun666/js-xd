<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="Uppwd.aspx.cs" Inherits="Admin_Uppwd" Title="Untitled Page" %>
                ...
                <table id="Table1" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 232px; height: 24px">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="输入新密码" ControlToValidate="txtpwd2"></asp:RequiredFieldValidator></td>
                    </tr>
                    <tr>
                        <td style="width: 90px; height: 24px">
                            确认密码：</td>
