<%@ Page Language="C#" AutoEventWireup="true" CodeFile="usersh.aspx.cs" Inherits="Admin_usersh" %>
                ...
                <asp:GridView ID="gvFilms" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="姓名">
                            <ItemTemplate>
                                <asp:Label ID="emal" runat="server" Text='<%# Bind("name") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="200px" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="性别">
                          ...
                          <asp:TemplateField HeaderText="所属单位">
                            <ItemTemplate>
                                <asp:Label ID="RoomName" runat="server" Text='<%# Bind("danwei") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="200px" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="联系方式">
                            <ItemTemplate>
                                <asp:Label ID="IsChk" runat="server" Text='<%# Bind("tel") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="200px" />
                        </asp:TemplateField>
                           <asp:TemplateField HeaderText="邮箱">
                            <ItemTemplate>
                                <asp:Label ID="Addtime" runat="server" Text='<%# Bind("Emal") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="200px" />
                        </asp:TemplateField>
