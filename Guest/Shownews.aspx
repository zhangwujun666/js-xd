<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="Shownews.aspx.cs" Inherits="Student_Shownews" Title="Untitled Page" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="ShopInfo" width="100%">
        <tr>
            <td align="center" bgcolor="#ffffff" style="height: 30px">
                &nbsp;
                <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="width: 688px">
                    <tr>
