<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="isscoreMybaogao.aspx.cs" Inherits="Student_isscoreMybaogao" Title="Untitled Page" %>
                ...
                <asp:GridView ID="gvFilms" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="得分">
                            <ItemTemplate>
                                <asp:Label ID="score" runat="server" Text='<%# Bind("score") %>' Width="34px"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="60px" />
                        </asp:TemplateField>
                           <asp:TemplateField HeaderText="评分老师">
                            <ItemTemplate>
                                <asp:Label ID="Teachternae" runat="server" Text='<%# Bind("Teachternae") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="实验时间">
                            <ItemTemplate>
                                <asp:Label ID="Addtime" runat="server" Text='<%# Bind("addtime","{0:d}") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="150px" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="实验报告">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="详细内容">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "IschktestContent.aspx?id="+Eval("id") %>'
