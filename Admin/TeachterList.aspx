<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="TeachterList.aspx.cs" Inherits="Admin_TeachterList" Title="Untitled Page" %>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="性别">
                         ...
                         <asp:TemplateField HeaderText="所属单位">
                            <ItemTemplate>
                                <asp:Label ID="Label3" runat="server" Text='<%# Bind("danwei") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="200px" />
                        </asp:TemplateField>
                       ...
                       <asp:TemplateField HeaderText="邮箱">
                            <ItemTemplate>
                                <asp:Label ID="Label5" runat="server" Text='<%# Bind("Emal") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="200px" />
                        </asp:TemplateField>
                         ...
                         <asp:TemplateField HeaderText="是否审核通过">
                            <ItemTemplate>
                                <asp:Label ID="Label6" runat="server" Text='<%# Bind("IsChk") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="200px" />
                        </asp:TemplateField>
