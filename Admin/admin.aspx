<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="admin.aspx.cs" Inherits="Admin_admin" Title="Untitled Page" %>
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="账号">
                         ...
                         <asp:TemplateField HeaderText="密码">
                            <EditItemTemplate>
                                <asp:TextBox ID="pwd" runat="server" Text='<%# Eval("pwd") %>' Width="60"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="pwd" runat="server"><%# Eval("pwd")%></asp:Label>
                            </ItemTemplate>
                            </asp:TemplateField>
                ...
                <table id="Table1" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td style="width: 90px; height: 24px">
                            &nbsp;密 码：</td>
                        <td style="width: 232px; height: 24px">
                            <asp:TextBox ID="TextBox1" runat="server" TextMode="Password" Width="216px"></asp:TextBox></td>
                    </tr>
                    <tr>
