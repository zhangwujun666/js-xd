...
<body style="background:url(../img/mainbg.jpg) fixed center center no-repeat ;background-size: cover; width: 100%;"> 
    <canvas></canvas>
    <div class="place">
    ...
    <div class="mainindex">
        ...
        <div class="welinfo">
            <span>
                <iframe style="background-color: white; border-radius: 5px;" name="sinaWeatherTool" src="http://weather.news.sina.com.cn/chajian/iframe/weatherStyle2.html?city=%E8%8B%8F%E5%B7%9E" width="200" height="20" marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0" scrolling="no"></iframe>
            </span><a href="#"></a>
        </div>
    </div>
     ...
     <div style="position: static; left: 0px; bottom: 0px;">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;您好，管理员(<asp:Label ID="user" runat="server" Text="Label" ForeColor="White" ></asp:Label>)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        您的IP地址是：<asp:Label ID="nativeIP" runat="server" Text="1" ForeColor="White" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        欢迎登录本系统！
...
<form id="form1" runat="server">
  <div>
    <table border="1" cellpadding="0" cellspacing="0" class="ShopInfo" width="100%" >
        <tr>
            <td align="left" bgcolor="White" style="height: 29px">
