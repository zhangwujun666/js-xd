<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="RoomList.aspx.cs" Inherits="Teachter_RoomList" Title="Untitled Page" %>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="所属客户">
                          ...
                          <asp:TemplateField HeaderText="单位">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="ZongRenshu" runat="server" Text='<%# Bind("ZongRenshu") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="80px" />
                        </asp:TemplateField>
                        
                          <asp:TemplateField HeaderText="年产量">
                            <ItemTemplate>
                                <asp:Label ID="HUoJiang" runat="server" Text='<%# Bind("HUoJiang") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="80px" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="备注信息">
                            <ItemTemplate>
                                <asp:Label ID="ds" runat="server" Text='<%# Bind("ds") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="80px" />
                        </asp:TemplateField>
