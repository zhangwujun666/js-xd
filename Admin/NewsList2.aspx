<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="NewsList2.aspx.cs" Inherits="Admin_NewsLisst" Title="Untitled Page" %>
                ...
                <asp:GridView ID="gvFilms" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="消息">
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("ds") %>' Width="800px"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                        </asp:TemplateField>
