...
<body>
    ...
    <div class="mainindex">
     ...
     <div style="position: static; left: 0px; bottom: 0px;">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;您好，会员(<asp:Label ID="user" runat="server" Text="Label"></asp:Label>)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <p>&nbsp;</p>
     ...
     <iframe class="calendar" src="../Calendar.aspx" style=" border:none; height:310px; width: auto "> </iframe>
     <iframe class="clock" src="../time2.aspx" style=" float:right ;border:none; height:310px; width: auto "> </iframe>
