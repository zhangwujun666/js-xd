<%@ Page Language="C#"   AutoEventWireup="true" CodeFile="addScore.aspx.cs" Inherits="Teachter_addScore" Title="Untitled Page" %>
                ...
                <asp:GridView ID="gvFilms" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="评分">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "pingfen.aspx?id="+Eval("id") %>'
                                    Text="评分"></asp:HyperLink>
                            </ItemTemplate>
