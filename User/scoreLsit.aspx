<%@ Page Language="C#"   AutoEventWireup="true" CodeFile="scoreLsit.aspx.cs"  EnableEventValidation="false"   Inherits="Teachter_scoreLsit" Title="Untitled Page" %>
            ...
            <td align="center" bgcolor="#ffffff" style="height: 30px">
                <asp:GridView ID="gvFilms" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="评定级别">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="项目报告书">
                            <ItemTemplate>
