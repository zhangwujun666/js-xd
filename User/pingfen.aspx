<%@ Page Language="C#"   AutoEventWireup="true" CodeFile="pingfen.aspx.cs" Inherits="Teachter_pingfen" Title="Untitled Page" %>
                ...
                <table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr style="color: #000000">
                        <td style="width: 94px; height: 24px">
                            得分：</td>
                        <td align="left" style="width: 320px; height: 24px">
                            <asp:TextBox ID="TextBox3" runat="server" MaxLength="200" Width="75px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td style="width: 94px; height: 24px">
                            实验用户：</td>
                    ...
                    <tr style="color: #000000">
                        <td style="width: 94px; height: 24px">
                            实验结论：</td>
                        <td align="left" style="width: 320px; height: 24px">
                            <asp:TextBox ID="TextBox1" runat="server" Height="110px" ReadOnly="True" TextMode="MultiLine"
                    ...
                    <tr style="color: #000000">
                        <td style="width: 94px; height: 24px">
                            填写评语：</td>
                        <td align="left" style="width: 320px; height: 24px">
                            <asp:TextBox ID="TextBox2" runat="server" Height="227px" TextMode="MultiLine" Width="551px"></asp:TextBox></td>
                    </tr>
                    <tr style="color: #000000">
