<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="Addteachter2.aspx.cs" Inherits="Addteachter2" Title="Untitled Page" %>
                    ...
                    <tr>
                        <td align="center" colspan="5" style="height: 25px; background-color: #ffffff">
                            ...
                            <asp:ImageButton ID="ImageButtonSave" runat="server" ImageUrl="../Images/BtnSave.gif"
                                OnClick="ImageButtonSave_Click" />       <asp:ImageButton ID="ImageButtonSave2" runat="server" ImageUrl="../Images/BtnBack.gif"
